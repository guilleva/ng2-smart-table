...
var DataSource = (function () {
    ...
    DataSource.prototype.renameColumn = function (oldKey, newKey) {
    };
...
__decorate$29([
    _angular_core.Output(),
    __metadata$23("design:type", Object)
], Ng2SmartTableTheadComponent.prototype, "titleChange", void 0);
__decorate$29([
    _angular_core.Output(),
    __metadata$23("design:type", Object)
...
Ng2SmartTableTheadComponent = __decorate$29([
    _angular_core.Component({
        ...
        template: "<tr ng2-st-thead-titles-row *ngIf=\"!grid.getSetting('hideHeader')\" class=\"ng2-smart-titles\" [grid]=\"grid\" [isAllSelected]=\"isAllSelected\" [source]=\"source\" (sort)=\"sort.emit($event)\" (titleChange)=\"titleChange.emit($event)\" (selectAllRows)=\"selectAllRows.emit($event)\"></tr><tr ng2-st-thead-filters-row *ngIf=\"!grid.getSetting('hideSubHeader')\" class=\"ng2-smart-filters\" [grid]=\"grid\" [source]=\"source\" (create)=\"create.emit($event)\" (filter)=\"filter.emit($event)\"></tr><tr ng2-st-thead-form-row *ngIf=\"grid.createFormShown\" [grid]=\"grid\" [createConfirm]=\"createConfirm\"></tr>",
    })
...
var ColumnTitleComponent = (function () {
    function ColumnTitleComponent() {
        this.sort = new _angular_core.EventEmitter();
        this.autompleteSelect = new _angular_core.EventEmitter();
    }
...
__decorate$34([
    _angular_core.Output(),
    __metadata$28("design:type", Object)
], ColumnTitleComponent.prototype, "autompleteSelect", void 0);
...
var LocalDataSource = (function (_super) {
     ...
     * @returns {LocalDataSource}
     */
    LocalDataSource.prototype.renameColumn = function (oldKey, newKey) {
        if (oldKey !== newKey) {
            var data = [];
